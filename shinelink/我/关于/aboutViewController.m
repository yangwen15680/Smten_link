...
- (void)_createHeaderView {
    ...
    [userImage setImage:[UIImage imageNamed:@"logo4.png"]];
...
-(void)checkUpdate{
 ...
 [self showProgressView];
    [BaseRequest requestWithMethodResponseJsonByGet:@"http://itunes.apple.com" paramars:@{@"admin":@"admin"} paramarsSite:@"/lookup?id=1078137068" sucessBlock:^(id content) {
        NSLog(@"getServicePhoneNum: %@", content);
        [self hideProgressView];
